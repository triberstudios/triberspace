      ...
      <div className="px-6 sm:px-8 py-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-sidebar-foreground leading-relaxed">
            ...
            <br /><br />
            <a href="https://blogs.nvidia.com/blog/what-is-extended-reality/" target="_blank" rel="noopener noreferrer" className="text-sidebar-foreground underline hover:no-underline">Immersive technology</a> is a powerful new medium for sharing our stories, culture, and memory across boundaries, and we believe it should be accessible to all — We built Triberspace to accomplish this.
          </p>
        </div>
        ...
        <div className="bg-sidebar rounded-xl p-8 border-3 border-sidebar mb-12">
          <h2 className="text-2xl font-semibold text-sidebar-foreground mb-6 flex items-center gap-3">
        ...
        <div className="bg-sidebar rounded-xl p-8 border-3 border-sidebar mb-12">
          ...
          <ul className="space-y-3">
            <li className="text-sidebar-foreground flex items-start gap-3">
              <span className="text-sidebar-foreground mt-2 w-1.5 h-1.5 rounded-full bg-sidebar-foreground shrink-0"></span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
          <div className="bg-sidebar rounded-xl p-8 border-3 border-sidebar">
            <h2 className="text-2xl font-semibold text-sidebar-foreground mb-4 flex items-center gap-3">
        ...
        {/* Values */}
        <div className="bg-sidebar rounded-xl p-8 border-3 border-sidebar mb-12">
          <h2 className="text-2xl font-semibold text-sidebar-foreground mb-8 flex items-center gap-3">
            <Heart className="w-6 h-6" />
            Our Values
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-background rounded-lg p-6 border border-sidebar-border">
              <h3 className="text-lg font-medium text-sidebar-foreground mb-3">Community</h3>
              <p className="text-sidebar-foreground/80">We foster and drive community - The tribe is greater than the singular.</p>
            </div>
            <div className="bg-background rounded-lg p-6 border border-sidebar-border">
              <h3 className="text-lg font-medium text-sidebar-foreground mb-3">Expression</h3>
              <p className="text-sidebar-foreground/80">We prioritize the human ability to create, express, and share stories.</p>
            </div>
            <div className="bg-background rounded-lg p-6 border border-sidebar-border">
              <h3 className="text-lg font-medium text-sidebar-foreground mb-3">Innovation</h3>
              <p className="text-sidebar-foreground/80">We push boundaries and foster innovative thinking in everything we do.</p>
            </div>
            <div className="bg-background rounded-lg p-6 border border-sidebar-border">
              <h3 className="text-lg font-medium text-sidebar-foreground mb-3">Access</h3>
              <p className="text-sidebar-foreground/80">We create space and opportunity for the under-recognized.</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center py-12">
          <h2 className="text-2xl sm:text-3xl font-semibold text-sidebar-foreground mb-8">
